...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="{{ URL::asset('assets/admin/dist/img/favicon.png')}}">
...
<body>
    ...
    <script src="{{ URL('assets/admin/plugins/datatables-colreorder/js/dataTables.colReorder.min.js')}}"></script>
