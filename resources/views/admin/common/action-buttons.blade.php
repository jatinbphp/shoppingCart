@if($section_name != 'contactus' && $section_name != 'cart_products' && $section_name != 'order_products' && !isset($order_dashboard))
...
@if($section_name != 'content' && $section_name != 'cart_products' && $section_name != 'order_products' && !isset($order_dashboard))
