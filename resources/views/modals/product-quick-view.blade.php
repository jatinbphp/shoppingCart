                ...
                <div class="quick_view_wrap">
                    <div class="quick_view_thmb">
                        <div class="quick_view_slide">
                            <div class="single_view_slide"><img src="{{url('assets/website/images/1.jpg')}}" class="img-fluid" alt="" /></div>
                            <div class="single_view_slide"><img src="{{url('assets/website/images/2.jpg')}}" class="img-fluid" alt="" /></div>
                            <div class="single_view_slide"><img src="{{url('assets/website/images/3.jpg')}}" class="img-fluid" alt="" /></div>
                            <div class="single_view_slide"><img src="{{url('assets/website/images/4.jpg')}}" class="img-fluid" alt="" /></div>
                        </div>
                    </div>
