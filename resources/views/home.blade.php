                            ...
                            <div class="row rows-products">
                                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                    <div class="product_grid card b-0">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single.html"><img class="card-img-top" src="{{url('assets/website/images/1.jpg')}}" alt="..."></a>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                    <div class="product_grid card b-0">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single.html"><img class="card-img-top" src="{{url('assets/website/images/2.jpg')}}" alt="..."></a>
                                                <div class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center">
                                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                    <div class="product_grid card b-0">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single.html"><img class="card-img-top" src="{{url('assets/website/images/3.jpg')}}" alt="..."></a>
                                                <div class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center">
                                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                    <div class="product_grid card b-0">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single.html"><img class="card-img-top" src="{{url('assets/website/images/4.jpg')}}" alt="..."></a>
                                                <div class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center">
                                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                    <div class="product_grid card b-0">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single.html"><img class="card-img-top" src="{{url('assets/website/images/5.jpg')}}" alt="..."></a>
                                                <div class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center">
                                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                    <div class="product_grid card b-0">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single.html"><img class="card-img-top" src="{{url('assets/website/images/6.jpg')}}" alt="..."></a>
                                                <div class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center">
                                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                    <div class="product_grid card b-0">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single.html"><img class="card-img-top" src="{{url('assets/website/images/7.jpg')}}" alt="..."></a>
                                                <div class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center">
                                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                                </div>
                                            </div>
                                ...
                                <div class="col-xl-3 col-lg-4 col-md-6 col-6">
                                    <div class="product_grid card b-0">
                                        ...
                                        <div class="card-body p-0">
                                            <div class="shop_thumb position-relative">
                                                <a class="card-img-top d-block overflow-hidden" href="shop-single.html"><img class="card-img-top" src="{{url('assets/website/images/8.jpg')}}" alt="..."></a>
                                                <div class="product-hover-overlay bg-dark d-flex align-items-center justify-content-center">
                                                    <div class="edlio"><a href="#" data-toggle="modal" data-target="#quickview" class="text-white fs-sm ft-medium"><i class="fas fa-eye mr-1"></i>Quick View</a></div>
                                                </div>
                                            </div>
